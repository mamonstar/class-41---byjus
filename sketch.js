...
function setup() {
 ...
 if(isMobile){
  ...
  button2.position(canW/2,70);
  button2.size(50,50);
  button2.mouseClicked(drop2);

  button3 = createImg('cut_btn.png');
  button3.position(canW/2+50,180);
  button3.size(50,50);
  ...
  rope2 = new Rope(6,{x:canW/2+20,y:70});
  rope3 = new Rope(2,{x:canW/2+100,y:200});
  ...
  bunny = createSprite(canW-80,canH-80,100,100);
  bunny.scale = 0.2;
